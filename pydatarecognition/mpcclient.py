...
class MPCClient:
    """A client backed by MPContribs.

    The MPContribs server will be automatically opened when the client is initiated.
    ...
    client : MPCClient
        The mpc client. It is initiate from the 'mongohost' attribute if it exists in rc. Otherwise,
